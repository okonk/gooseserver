...
public class ManifestTests : IDisposable
{
    ...
    /// <summary>The manifest is regenerated by the client's toolchain, so a truncated or
    /// otherwise malformed file is a plausible failure, not a hypothetical.</summary>
    [Fact]
    public void Malformed_json_names_the_file()
    {
        var dir = WriteManifest("""{"tileSize":32,"sheets":{"7":{"42":[1,2,3""");
