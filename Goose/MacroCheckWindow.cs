...
namespace Goose
{
    public class MacroCheckWindow : Window
    {
        ...
        {
            int lineno = 1;
            world.Send(player, P.WindowTextLine(this.ID, lineno++, "You have been suspected of macroing."));
            world.Send(player, P.WindowTextLine(this.ID, lineno++, "To pass this check type:"));
            world.Send(player, P.WindowTextLine(this.ID, lineno++, "/mc " + code));
            lineno++;
            world.Send(player, P.WindowTextLine(this.ID, lineno++, "If you pass you will gain 1mil xp."));
            world.Send(player, P.WindowTextLine(this.ID, lineno++, "If you don't you will be kicked."));
            world.Send(player, P.WindowTextLine(this.ID, lineno++, "Multiple failures will be a ban."));
            world.Send(player, P.WindowTextLine(this.ID, lineno++, "You have 10 minutes."));
            world.Send(player, P.WindowTextLine(this.ID, lineno++, "You have been warned. :)"));
        }
