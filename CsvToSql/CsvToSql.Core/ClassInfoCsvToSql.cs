...
namespace CsvToSql
{
    public class ClassInfoCsvToSql : CsvToSqlBase
    {
        ...
        public override Column[] GetColumnDescriptors() => new[]
        {
            ...
            Col.Decimal("hp_percent_regen", def: "0"),
            Col.Int("hp_static_regen", SqlType.Int, def: 0),
            Col.Decimal("mp_percent_regen", def: "0"),
            Col.Int("mp_static_regen", SqlType.Int, def: 0),
            Col.Decimal("haste", def: "0"),
            Col.Decimal("spell_damage", def: "0"),
            Col.Decimal("spell_crit", def: "0"),
            Col.Decimal("melee_damage", def: "0"),
            Col.Decimal("melee_crit", def: "0"),
            Col.Decimal("damage_reduce", def: "0"),
        };
    }
}
